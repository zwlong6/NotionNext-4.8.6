...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5 a
  NOTION_PAGE_ID:
  ...
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://zzzero.site', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客, 技术分享, 编程, 开发, 前端, 后端, 全栈, 学习笔记, 经验分享, ZhouZhou, zhouzhou, zzzero.site, zzzero', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个打工人,以归零的心态，敢于未知,欢迎来到我的博客🎉',
